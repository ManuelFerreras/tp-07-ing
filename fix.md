...
- contar sobre el codigo, preparar un pipeline que falle por un cambio en la logica de negocio y que el pipeline se detenga.
- modificar el front, mostrar que corrio el pipeline y que realmente cambio en el front final.
